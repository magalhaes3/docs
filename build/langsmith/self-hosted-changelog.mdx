...
<Update label="2026-08-24" tags={["self-hosted"]} rss={{ title: "2026-08-24 - self-hosted" }}>
...
<Update label="2026-08-22" tags={["self-hosted"]} rss={{ title: "2026-08-22 - self-hosted" }}>
...
<Update label="2026-08-21" tags={["self-hosted"]} rss={{ title: "2026-08-21 - self-hosted" }}>
